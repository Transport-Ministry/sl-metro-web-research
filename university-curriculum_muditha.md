...
|---------|------------------|----------------------------------|
| Machine Learning | ML fundamentals such as supervised and unsupervised learning, model training, classification, and evaluation.  | AI/ML component of the metro project |
| Current Trends in Software Engineering | Docker / AWS | Dockerization, Hosting and Deployment knowledge |
| Preparation for the Professional World | Professional communication, teamwork, career preparation, and industry practices. | Improve documentation, reporting, presentations, and professional conduct during the metro project. |
| Research Project | A major group research project involving problem identification, literature review, design, development, and evaluation. Main focus is on semantic analysis and intelligent decision-making models. | This subject directly involves developing and implementing the proposed system and documenting the research findings. |
...
|------|--------------------|----|
| Frontend (HTML/CSS/JS) | ⭐⭐⭐ Comfortable | Built many projects (Web applications) |
| Backend (Node/Python) | ⭐⭐⭐ Comfortable | Built many projects (Web applications) |
| Databases | ⭐⭐ Basic | Has query knowledge in many SQL versions and used both SQL \ NoSQL databases for development |
| Git / GitHub | ⭐ Beginner | This is my first industry level Git activity (Still a lot to learn) |
| UI/UX Design | ⭐⭐ Some | Used Figma in a few class assignment (Do not enjoy it) |

---

## 6. What I Want to Learn in This Training

1. Using Git and GitHub properly in a team workflow
...
5. Learning how to deploy applications to cloud platforms
6. Improving my debugging and problem-solving skills
...
|---------|-------------|-------------------|--------|
| GreenLoop – Smart Waste Management System | A web platform that helps manage waste collection, scheduling, and payments. | MERN, Firebase, Stripe | Completed |
| Food Ordering and Delivery System | A microservices-based system for ordering and delivering food with scalable architecture. | MERN, Docker, Kubernetes | Completed |
| Tax-Trail Mobile Application | A mobile application that promotes transparency in public budget data with AI-assisted insights. | React Native, Expo, LangChain, GroqAI, Appwrite | Completed |
| AutoBook – Automotive Service Integration System | A system that allows users to book vehicle services and manage service records online. | MERN Stack | Completed |
| LEETGames Gaming Web Application | A gaming community platform with discussion forums and user management. | Java, MVC, Apache Tomcat | Completed |
| Task Manager Mobile App | A mobile application to manage daily tasks and schedules. | Kotlin, SQLite | Completed |
| Personal Portfolio | Showcases my work | Java, React.js, Express.js, React Native | On-going |